...
import 'package:base/utils/DateUtil.dart';

import '../../base/adapter/BaseAdapter.dart';
import 'package:base/painting/MyDecoration.dart';
    ...
    return LinearWidget(
      ...
      children: [
        Container(
          ...
          child: Row(
            children: [
              TextView("时间筛选",size: 16,color: CstColors.cl_161722,).buildExpanded(),
          ...
          child:  Row(
            children: List.generate(controller.weekDay.length, (index){
              return Expanded(child: Center(
                child: TextView(controller.weekDay[index],size: 14,color: CstColors.cl_7B8290,),
              ));
            }).toList(),
          ),
        ),
            ...
            adapter: BaseAdapter<String>(
                ...
                builder: (context,index,model){
                  ...
                  return LinearWidget(
                    ...
                    children: [
                      SizedBox(height: 20,),
                      TextView("${yearMonth[0]}年${yearMonth[1]}月",size: 14,color: CstColors.cl_161722,),
                      SizedBox(height: 20,),
                      WidgetUtils.buildGrid(
                          ...
                          adapter: BaseAdapter<DateTime>(
                              ...
                              builder: (context,index,model){
                                ...
                                {
                                  decoration = MyDecoration.buildShape(radius: 8,solid: CstColors.cl_01C6AC);
                                }
                                else if(null != controller.endTime){
                                  if(model.isAfter(controller.startTime) && model.isBefore(controller.endTime))
                                    decoration = MyDecoration.buildShape(solid: CstColors.cl_C8FAF3);
                                  else
                                    decoration = null;
                                }
                                else{
                                ...
                                return Container(
                                  ...
                                  child: TextView(DateUtil.isToday(model) ? "今天" :model?.day?.toString()??"",size: 16,color: CstColors.cl_161722,
