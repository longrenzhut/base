...
import 'package:base/widget/StackWidget.dart';
import 'package:base/widget/SuperTextView.dart';
  ...
  Widget build(BuildContext context) {
    return SafeArea(child: Column(
      ...
      children: [
        LinearWidget(
          ...
          children: [
            Container(
              ...
              height: 60,
              child: TextView(controller.title,size: 14,color: CstColors.cl_7B8290,),
            ),
            Container(
                alignment: Alignment.center,
                ...
                child: WidgetUtils.buildList(
                  ...
                  adapter: BaseAdapter<String>(
                    ...
                    builder: (context,index,model){
                      var selectedColor = index == controller.index? CstColors.cl_01C6AC : CstColors.cl_161722;
                      return Stack(
                        children: [
                          Container(
        ...
        Container(
          margin: EdgeInsets.only(left: 10,right: 10),
          child:  SuperTextView("取消",size: 18,color: CstColors.cl_161722,
            margin: EdgeInsets.only(left: 10,right: 10),
