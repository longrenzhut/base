...
//        context.startActivity(intent);
    ...
    private fun isScreenReaderActive(context: Context): Boolean {
        ...
        if (Build.VERSION.SDK_INT <= 15) {
            ...
            // 高版本可以直接判断服务是否处于开启状态
            for (screenReader in screenReaders) {
                hasActiveScreenReader = hasActiveScreenReader or isAccessibilitySettingsOn(context, screenReader.serviceInfo.packageName + "/" + screenReader.serviceInfo.name)
            }
        } else {
