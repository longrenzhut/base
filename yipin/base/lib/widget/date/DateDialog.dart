...
import 'package:base/base/widget/BaseWidget.dart';
    ...
    return LinearWidget(
      ...
      children: [
        Row(
          ...
          children: [
            TextView("跑动时间",size: 16,color: CstColors.cl_161722,weight: FontWeight.bold,),
        ...
        SuperTextView("确定",solid: CstColors.cl_01C6AC,size: 16,
          height: 46,
